...
function Courses() {
  ...
  return (
    <div className="flex">
      ...
      > */}
      <aside
        className={`fixed top-0 left-0 h-screen w-64 bg-gray-100 p-5 z-10
  ...
  md:translate-x-0`}
      ...
      {/* Main content */}
      <main className="w-full md:ml-64 bg-gray-50 min-h-screen px-4 md:px-8 py-6">
        {" "}
        {/* Header */}
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-3 w-full md:w-auto">
            <div className="flex items-center w-full md:w-auto">
              ...
              />
              <button className="h-10 border border-gray-300 rounded-r-full px-4 flex items-center justify-center bg-white">
              ...
              {courses.map((course) => (
                ...
                >
                  ...
                  <div className="h-40 w-full overflow-hidden">
                    <img
                      src={course?.imageUrl?.url || "/default.png"}
                      alt={course.title}
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <Link
                      to={`/buy/${course._id}`}
                      className="text-center bg-orange-500 text-white py-2 rounded-lg hover:bg-orange-600 transition duration-300"
                    >
                      Buy Now
                    </Link>
                  </div>
